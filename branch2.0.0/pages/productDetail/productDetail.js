...
Page({
  ...
  confirmShop() {
    ...
    if (that.data.is_add_shopcar == 1) { //添加购物车
      ...
      wx.navigateTo({
        url: '/pages/productDetail/payOrderDetail/payOrderDetail?sku_id='+that.data.sku_id+'&num='+that.data.inputValue+'&data_id='+that.data.data_id+'&live_id'+that.data.live_id,
      })
    }
  },
