  ...
  return function (m) {
    ...
    this._client = a; this._keepAliveInterval = 1E3 * b; this.isReset = !1; var d = (new q(12)).encode(), c =
      ...
      null; c.prototype.hostIndex = null; c.prototype.onConnected = null; c.prototype.onConnectionLost = null; c.prototype.onMessageDelivered = null; c.prototype.onMessageArrived = null; c.prototype.traceFunction = null; c.prototype._msg_queue = null; c.prototype._buffered_msg_queue = null; c.prototype._connectTimeout = null; c.prototype.sendPinger = null; c.prototype.receivePinger = null; c.prototype._reconnectInterval = 1; c.prototype._reconnecting = !1; c.prototype._reconnectTimeout = null; c.prototype.disconnectedPublishing = !1; c.prototype.disconnectedBufferSize =
        ...
        null ===
          ...
          var b = m.getStorageSync(a), d = JSON.parse(b), c = new q(d.type, d); switch (d.type) {
            case 3: for (var b = d.payloadMessage.payloadHex, e = new ArrayBuffer(b.length / 2), e = new Uint8Array(e), f = 0; 2 <= b.length;) {
              var n = parseInt(b.substring(0, 2), 16), b = b.substring(2,
                b.length); e[f++] = n
        ...
        }; c.prototype._process_queue =
          function () { for (var a = null, b = this._msg_queue.reverse(); a = b.pop();)this._socket_send(a), this._notify_msg_sent[a] && (this._notify_msg_sent[a](), delete this._notify_msg_sent[a]) }; c.prototype._requires_ack = function (a) {
            var b = Object.keys(this._sentMessages).length; if (b > this.maxMessageIdentifier) throw Error("Too many messages:" + b); for (; void 0 !== this._sentMessages[this._message_identifier];)this._message_identifier++; a.messageIdentifier = this._message_identifier; this._sentMessages[a.messageIdentifier] = a; 3 ===
              a.type && this.store("Sent:", a); this._message_identifier === this.maxMessageIdentifier && (this._message_identifier = 1)
          ...
          this._reconnecting || this._disconnected(g.SOCKET_ERROR.code, h(g.SOCKET_ERROR,
            ...
            var e; if ("string" !== typeof a) throw Error(h(g.INVALID_TYPE, [typeof a, "host"])); if (2 == arguments.length) {
              ...
              3 == arguments.length && (k = d, d = "/mqtt"); if ("number" !== typeof b || 0 > b) throw Error(h(g.INVALID_TYPE, [typeof b, "port"])); if ("string" !== typeof d) throw Error(h(g.INVALID_TYPE, [typeof d, "path"])); var is_test = getApp().globalData.is_test;
              if (!is_test) {
                e = 'wss://ws.topshopstv.com';
              } else {
                e = "ws://" + (-1 !== a.indexOf(":") && "[" !== a.slice(0, 1) && "]" !== a.slice(-1) ? "[" + a + "]" : a)
              }
            
             
            } for (var n = f = 0; n < k.length; n++) { var m = k.charCodeAt(n); 55296 <= m && 56319 >= m && n++; f++ } if ("string" !== typeof k || 65535 < f) throw Error(h(g.INVALID_ARGUMENT, [k, "clientId"])); var l = new c(e, a, b, d, k); this._getHost = function () { return a };
